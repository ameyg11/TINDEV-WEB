  ...
  <li className="flex items-start gap-3">
    <div
      className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center mt-0.5 ${
        highlighted ? "bg-yellow-300/30" : "bg-gray-300 dark:bg-gray-700"
      }`}
    >
      <CheckIcon
...
const Premium = () => {
  ...
  const handleBuyClick = async (type) => {
    try {
      ...
      const options = {
        ...
        name: "TinDev",
        description:
          "Connect to other developers seamlessly with some cool features",
  ...
  return isUserPremium ? (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-gray-800 p-6">
      <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-10 text-center shadow-2xl max-w-md">
        ...
        <p className="text-gray-300 mb-6">
          Thank you for supporting TinDev. You now have access to exclusive
          features & priority matchmaking.
        </p>
    ...
    <div className="relative font-sans flex flex-col items-center justify-center bg-white dark:bg-black min-h-screen px-4 py-20">
      ...
      <p className="text-gray-600 dark:text-gray-300 mt-4 text-center max-w-xl">
        Pick a plan that fits your workflow and unlock powerful tools to help
        your team grow.
      </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl w-full">
        ...
        <div className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white p-8 rounded-2xl shadow-lg">
          ...
          <button
            ...
            className="w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-semibold py-3.5 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition"
          >
            Get Silver
          </button>
        ...
        <div className="bg-gradient-to-b from-yellow-400 to-yellow-600 text-black p-8 rounded-2xl shadow-xl border border-yellow-300">
          ...
          <p className="mb-8 text-sm text-black ">
            Advanced tools, high performance, integrations, and priority
            support.
          </p>

          <button
            onClick={() => handleBuyClick("gold")}
            className="w-full bg-white text-yellow-900 font-semibold py-3.5 rounded-lg hover:bg-gray-100 transition"
          >
            Get Gold
          </button>
